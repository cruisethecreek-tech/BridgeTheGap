...
const CASES = {
  'totally empty': {},
  'legacy save (none of the new keys)': {onboarded:true, mindOff:true,activeMonth:'2026-08',intensity:'blunt',
  ...
  'enormous numbers': {onboarded:true, mindOff:true,activeMonth:'2026-08',hourlyWage:1e6,
  ...
  'negative + zero balances': {onboarded:true, mindOff:true,activeMonth:'2026-08',hourlyWage:0,
  ...
  'fractional cents': {onboarded:true, mindOff:true,activeMonth:'2026-08',hourlyWage:19.9999,
  ...
  'leap day + month ends': {onboarded:true, mindOff:true,activeMonth:'2028-02',
  ...
  'corrupt records': {onboarded:true, mindOff:true,activeMonth:'2026-08',
  ...
  'deep nesting fully funded': {onboarded:true, mindOff:true,activeMonth:'2026-08',
