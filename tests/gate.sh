...
PROBES="credit rates acct swipe cardfind qlparse qlocr qlblank brief working
        ...
        twotabs weekly budgetmode explain fold vault mindset truecost statmath acctno whose household escrow putaway trendcap numpad picker deckhold trace twophones cta qlblocks onething learns"
